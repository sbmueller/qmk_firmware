 ...
 */
    [_SYM] = LAYOUT(
     ...
     _______, KC_BSLS, KC_COLN, KC_SCLN, KC_EQL,  KC_PLUS, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, KC_MINS, KC_UNDS, KC_COMM, KC_DOT,  KC_PIPE, _______,
                                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
...
#define FULL_SIZE 1024 // number of bytes in array, minimize for adequate firmware size, max is 1024
...
static void render_anim(void) {
    static const char PROGMEM base[ANIM_SIZE] = {
        // 'lower base half', 128x32px
    ...
    static const char PROGMEM tap[TAP_FRAMES][FULL_SIZE] = {
        {
        // 'tap_left', 128x64px
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
        0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    void animation_phase(void) {
        if(get_current_wpm() < ANIM_WPM_LOWER){
            ...
            oled_set_cursor(0, 4);
            oled_write_raw_P(base, ANIM_SIZE);
         }
         if(get_current_wpm() >=ANIM_WPM_LOWER){
