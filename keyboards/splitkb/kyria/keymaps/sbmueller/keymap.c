 ...
 */
    [_QWERTY] = LAYOUT(
     ...
     MT(MOD_LSFT, KC_LBRC), KC_Z, KC_X, KC_C,     KC_V,    KC_B,   KC_LBRC, FKEYS,  ADJUST,  KC_RBRC, KC_N,   KC_M,    KC_COMM, KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_RBRC),
 ...
 */
    [_COLEMAK_DH] = LAYOUT(
     ...
     MT(MOD_LSFT, KC_LBRC) , KC_Z, KC_X, KC_C,     KC_D,    KC_V,   KC_LBRC, FKEYS,  ADJUST,  KC_RBRC, KC_K,   KC_H,    KC_COMM, KC_DOT, KC_SLSH, MT(MOD_RSFT, KC_RSFT),
                                         KC_MUTE , KC_LGUI, KC_SPC, NAV,     KC_DEL, KC_RALT, SYM,     KC_SPC, ALT_ENT, KC_APP
    ),
 ...
 */
    [_SYM] = LAYOUT(
     ...
     KC_LCBR, KC_BSLS, KC_COLN, KC_SCLN, KC_MINS, KC_UNDS, KC_LCBR, KC_LBRC, KC_RBRC, KC_RCBR, KC_EQL,  KC_PLUS, KC_COMM, KC_DOT,  KC_PIPE, KC_RCBR,
                                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______
    ),
...
bool oled_task_user(void) {
    if (is_keyboard_master()) {
        ...
        oled_write_P(PSTR("Keymap: sbmueller\n\n"), false);
