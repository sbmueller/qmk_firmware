...
enum layers { MAC_BASE, WIN_BASE, MAC_FN, WIN_FN, COM_FN, UTL };
// clang-format off
...
const uint16_t PROGMEM encoder_map[][2][2] = {
    [MAC_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU),ENCODER_CCW_CW(KC_WH_U, KC_WH_D)},
    [WIN_BASE] = {ENCODER_CCW_CW(KC_VOLD, KC_VOLU),ENCODER_CCW_CW(KC_WH_U, KC_WH_D)},
